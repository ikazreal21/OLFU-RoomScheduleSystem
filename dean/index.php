...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="#">Welcome <?php echo $_SESSION['login_dean']; ?></a>
                    </li>
                    <li>
                        <a href="pending_spcb.php">AVR Event Request</a>
                    </li>
                    <li>
    ...
    <?php $login_client = $_SESSION['login_dean'];
...
<td>
    <a href="../schedule/schedule.php?id=<?php echo $row["user_id"] ?>"> View Schedule </a>
</td>
</tr>
<?php }?>
</table>
