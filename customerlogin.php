                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
                                    <ul class="dropdown-menu">
                                        <li> <a href="entercar.php">Add Room</a></li>
        ...
        <div class="container" style="margin-top: -2%; margin-bottom: 2%;">
            <div class="col-md-5 col-md-offset-4">
                ...
                <div class="panel panel-primary">
                  <center>  <div class="panel-css"> Login </div> </center>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-xs-4">
                                    <button class="btn-css" name="submit" type="submit" value=" Login ">Submit</button>

                                </div>

                            </div>
                            <label style="margin-left: 5px;">or</label> <br>
                            <label style="margin-left: 5px;"><a href="customersignup.php">Request an account</a></label>
                        </form>
                    </div>
                </div>
            </div>
