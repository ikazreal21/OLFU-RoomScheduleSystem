...
$sql1 = "SELECT * FROM schedules rc, room c, users u WHERE u.customer_username=rc.customer_username and c.car_id=rc.car_id and rc.booking_status='pending' order by rc.id desc  ";
